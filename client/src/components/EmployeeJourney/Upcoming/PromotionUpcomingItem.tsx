...
interface PromotionUpcomingItemProps {
  title: string;
  data: any;
  record: any;
  employee: any;
...
const PromotionUpcomingItem: React.FC<PromotionUpcomingItemProps> = (props) => {
  const intl = useIntl();
    ...
    <>
      <thead>
        <tr>
          ...
          <th colSpan={2} style={{ color: '#626D6C' }}>
            <FormattedMessage
        ...
        <Space style={{ float: 'right' }}>
          <ModalForm
            title={intl.formatMessage({
              id: 'employee_journey.rollback_promotion',
              defaultMessage: 'Rollback Promotion',
            })}
          ...
          <ModalForm
            title={intl.formatMessage({
              id: 'employee_journey.reupdate_promotion',
              defaultMessage: 'Reupdate Promotion',
            })}
...
export default PromotionUpcomingItem;
