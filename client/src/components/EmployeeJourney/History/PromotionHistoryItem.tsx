...
const PromotionHistoryItem: React.FC<PromotionHistoryItemProps> = (props) => {
    ...
    return (
        <Timeline.Item color='#86C129' className='timeline-head-center'>
            <Card className='timeline-card' style={{ borderColor: '#86C129' }}>
                <div onClick={() => setIsVisibleDetails(!isVisibleDetails)}>
                    ...
                    <Typography.Text>
                        <Tag color="#86C129">
                            <FormattedMessage
                                id="employee_journey_update.promoted"
                ...
                {isVisibleDetails && <Row style={{ marginTop: 18 }}>
                    ...
                    <Col span={12}>
                        <Row>
                            ...
                            <Col span={12}>
                                <Typography.Text className='colon-before-text'>
                                    {props.data?.calendars?.find(option => option.value == props.record?.calendarId)?.label}
                                </Typography.Text>
                            </Col>
                        </Row>
                    </Col>
                    ...
                    <Col span={24}>
                        <Row>
                            ...
                            <Col span={16}>
                                <Typography.Text className='colon-before-text'>
                                    {props.data?.promotionTypes?.find(option => option.value == props.record?.promotionTypeId)?.label}
                                </Typography.Text>
                            </Col>
                        </Row>
                    </Col>
