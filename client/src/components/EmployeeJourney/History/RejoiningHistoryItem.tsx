...
interface RejoiningHistoryItemProps {
    data: any,
    record: any,
    employee: any
}

const RejoiningHistoryItem: React.FC<RejoiningHistoryItemProps> = (props) => {
            ...
            <Card className='timeline-card' style={{borderColor: '#909A99'}}>
                <div onClick={() => setIsVisibleDetails(!isVisibleDetails)}>
                    ...
                    <Typography.Text>
                        <Tag color="#909A99">
                            <FormattedMessage
                                id="employee_journey_update.rejoined"
                                defaultMessage="Rejoined"
                            />
                        </Tag>
...
export default RejoiningHistoryItem;
