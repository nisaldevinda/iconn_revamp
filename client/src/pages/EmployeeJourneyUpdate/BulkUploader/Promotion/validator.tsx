  ...
  useEffect(() => {
    const _columns = [
      ...
      },
      {
        ...
        valueType: 'select',
        request: async () => props.supportData.jobCategories.map((option: any) => {
          return {
            value: option.id,
            label: option.name,
          }
        ...
        render: (dom: any, record: any) => <Space direction='vertical' style={{textAlign: 'left', width: '100%'}}>
          <Typography.Text>{dom}</Typography.Text>
          <Typography.Text type="danger">{record.error.jobCategoryId}</Typography.Text>
        </Space>,
        width: 200
      },
      {
      ...
      },
      {
        ...
        dataIndex: 'reportsToEmployeeId',
        valueType: 'select',
        request: async () => props.supportData.reportingPersons.map((option: any) => {
          return {
            value: option.id,
            label: option.name,
          }
        ...
        render: (dom: any, record: any) => <Space direction='vertical' style={{textAlign: 'left', width: '100%'}}>
          <Typography.Text>{dom}</Typography.Text>
          <Typography.Text type="danger">{record.error.reportsToEmployeeId}</Typography.Text>
        </Space>,
        width: 200
      },
      {
        title: 'Functional Reporting Person',
        dataIndex: 'functionalReportsToEmployeeId',
        valueType: 'select',
        request: async () => props.supportData.reportingPersons.map((option: any) => {
          return {
            value: option.id,
        ...
        render: (dom: any, record: any) => <Space direction='vertical' style={{textAlign: 'left', width: '100%'}}>
          <Typography.Text>{dom}</Typography.Text>
          <Typography.Text type="danger">{record.error.functionalReportsToEmployeeId}</Typography.Text>
        </Space>,
        width: 200
      },
      {
      ...
      },
      {
        ...
        valueType: 'select',
        request: async () => props.supportData.promotionTypes.map((option: any) => {
          return {
            value: option.id,
            label: option.name,
          }
        ...
        render: (dom: any, record: any) => <Space direction='vertical' style={{textAlign: 'left', width: '100%'}}>
          <Typography.Text>{dom}</Typography.Text>
          <Typography.Text type="danger">{record.error.promotionTypeId}</Typography.Text>
        </Space>,
        width: 200
      },
      {
        ...
        render: (dom: any, record: any) => <Space direction='vertical' style={{textAlign: 'left', width: '100%'}}>
          <Typography.Text>{dom}</Typography.Text>
          <Typography.Text type="danger">{record.error.promotionReason}</Typography.Text>
        </Space>,
        width: 200
      },
      {
