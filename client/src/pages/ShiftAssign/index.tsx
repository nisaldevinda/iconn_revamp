...
export default (): React.ReactNode => {
    ...
    const onFinish = async (formData: any) => {
        ...
        try {
            const { message, data } = await assignShifts(requestData);
                                            ...
                                            rules={[
                                                {
                                                    ...
                                                    message: intl.formatMessage({
                                                        id: 'shiftAssign.shiftId.required',
                                        ...
                                        >
                                            <Select
                                                ...
                                                placeholder={intl.formatMessage({
                                                    id: 'shiftAssign.workshift.placeholder',
                                                ...
                                                onChange={async (value) => {
                                                    ...
                                                    const assignedEmp = await getAssignShifts(value);
