...
const EditUser: React.FC<EditFormProps> = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.values.typeColor) {
            setColor(props.values.typeColor);
            setIconColor(props.values.typeColor);
        }
    }, [props.values]);
            ...
            <Col span={12}>
                <div style={{ display: 'flex' }} className="color-input" >
                    <ProFormText
                        ...
                        initialValue={null}
                    />
                    <Button disabled = {props.values.isReadOnly} onClick={() => {
                        if (!showColorPicker) {
                            setShowColorPicker(true);
                        } else {
                            setShowColorPicker(false);
                        }
                    }} style={{ borderTopLeftRadius: 0, borderBottomLeftRadius: 0, marginLeft: -4, marginTop: 30, zIndex: 2 }} ><BgColorsOutlined style={styles.colorVal} /></Button>
