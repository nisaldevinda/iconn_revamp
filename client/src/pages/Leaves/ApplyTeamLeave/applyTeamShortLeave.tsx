...
const ApplyShortLeaveForEmployees: React.FC = () => {
  ...
  const assignLeave = async () => {
    try {
      if (fileFormatError) {
        ...
        const result = await addTeamShortLeave(params);
  ...
  return (
    <>
      ...
      >
        <LeaveHistoryList listType="shortLeave" employeeId={selectedEmployee}></LeaveHistoryList>
      </ModalForm>
    </>
  );
};

export default  ApplyShortLeaveForEmployees;
