...
return [
    ...
    'basic' => [
        ...
        'SUCC_SINGLE_RETRIVE' => 'Religion loaded successfully.',
        'SUCC_ALL_RETRIVE' => 'Religion loaded successfully.',
        'ERR_CREATE' => 'Cannot Save.Something went wrong,Try again',
        'ERR_UPDATE' => 'Cannot Update.Something went wrong,Try again',
        'ERR_SINGLE_RETRIVE' => 'Failed to load religion.',
        'ERR_ALL_RETRIVE' => 'Failed to load schemes.',
        'ERR_DELETE' => 'Cannot Delete.Something went wrong,Try again',
        'ERR_INVALID_CREDENTIALS' => 'Religion name is invalid.',
        'ERR_NONEXISTENT_RELIGION' => 'Religion does not exist',
