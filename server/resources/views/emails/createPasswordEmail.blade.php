                ...
                <tr>
                  <td style="padding:0 55px;">
                    ...
                    <p style="text-align:justify; color:#474747;  font-size:15px;line-height:24px; width:98%;">
                      We are excited to have you get started. First, you need to set up a password.
                      Just press the button below.
                    </p>
                    <a href="{{ $data['createLink'] }}" style="background:#86C129;text-decoration:none !important; font-weight:500; margin-top:35px; color:#FFFFFF; font-size:14px;padding:10px 24px;display:inline-block;">Set Up 
                      Password</a>
                    <br><br>
