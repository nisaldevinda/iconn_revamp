...
class UpdateContractRenewalDateCalculateFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $script = 'CREATE OR REPLACE FUNCTION `contractRenewalDateCalculate` (currentJobsId INT) RETURNS VARCHAR(20) no sql deterministic
            BEGIN
                ...
                DECLARE _employmentStatusCategory VARCHAR(20);
                ...
                SET _employmentStatusCategory = (SELECT category FROM employmentStatus WHERE id = _employmentStatusId);

                IF _employmentStatusCategory = "PERMANENT" THEN
