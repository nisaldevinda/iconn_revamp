...
class CreateCancelShortLeaveRequestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cancelShortLeaveRequest', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('employeeId')->nullable()->default(null);
            $table->integer('shortLeaveRequestId')->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('cancelShortLeaveRequest');
    }
}
