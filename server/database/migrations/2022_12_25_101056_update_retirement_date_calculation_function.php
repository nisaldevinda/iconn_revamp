...
class UpdateRetirementDateCalculationFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $script = 'CREATE OR REPLACE FUNCTION `retirementDateCalculate` (dateOfBirth Date, hireDate Date) RETURNS VARCHAR(20) no sql deterministic
            BEGIN
                ...
                RETURN DATE_FORMAT(DATE_ADD(dateOfBirth, INTERVAL minimumRetirementAge YEAR), "%d-%m-%Y");
            END;';
