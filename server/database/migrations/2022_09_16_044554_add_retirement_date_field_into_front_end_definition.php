...
class AddRetirementDateFieldIntoFrontEndDefinition extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        if ($editrecord) {
            ...
            if ($employmentTabKey > -1 && $basicCardKey > -1) {
                ...
                $hasForenameField = in_array("retirementDate", $basicCardContent);
                if (!$hasForenameField) {
                    array_push($basicCardContent, "retirementDate");
                }
        ...
        if ($editrecord) {
            ...
            if ($employmentTabKey > -1 && $basicCardKey > -1) {
                ...
                $basicCardContent = array_filter($basicCardContent, function($str) {
                    return strpos($str, 'retirementDate') === false;
                });
