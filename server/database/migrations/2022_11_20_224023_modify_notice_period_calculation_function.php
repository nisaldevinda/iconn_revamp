...
class ModifyNoticePeriodCalculationFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $script = 'CREATE OR REPLACE FUNCTION `noticePeriodCalculation` (currentJobsId INT) RETURNS VARCHAR(20) no sql deterministic
            BEGIN
